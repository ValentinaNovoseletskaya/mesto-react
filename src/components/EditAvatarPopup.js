...
function EditAvatarPopup(props) {
    ...
    return (
        <PopupWithForm title='Обновить аватар' name='avatar' buttonText={props.loadingText ? props.loadingText : 'Сохранить' } onSubmit={handleSubmit} isOpen={props.isOpen} onClose={props.onClose}>
